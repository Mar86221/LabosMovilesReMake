package com.example.modelotracker.ui.modelo.viewmodel
...
class ModeloViewModel(private val repository: ModeloRepository) : ViewModel() {
    ...
    fun setSelectedModelo(modelo: ModeloModel){
        name.value = modelo.name
        category.value = modelo.category
        description.value = modelo.description
        qualification.value = modelo.qualification
    }
